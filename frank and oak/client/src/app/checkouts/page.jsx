...
export default function Checkout() {
  ...
  const handleCheckout = (e) => {
    ...
    axios.post(`${process.env.NEXT_PUBLIC_URL}/payment/create-checkout`,{
      address:formObject,
      cart,totalPrice
    })
    .then((response)=>{
    ...
    <>
      ...
      <section className="grid lg:grid-cols-[55%_auto] grid-cols-1 mx-auto font-Poppins">
            ...
            <div className="space-y-4 py-5">
              ...
              <div className="grid grid-cols-3 gap-3">
                <div class="relative">
                  ...
                  <label
                    for="floating_filled"
                    class="absolute text-sm  duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] start-2.5 peer-focus:text-blue-600 
        ...
        <div
          ...
          } h-screen duration-200 bg-[#F4F8F7] p-10 lg:order-2 order-1`}
        >
          <div className="lg:w-[75%] w-full">
            ...
            <div className="border-t border-[#E3E3E3] py-5 mt-5">
              ...
              <div className="pt-5 space-y-3">
                <div className="flex justify-between ">
                  <div className="text-sm font-normal">Subtotal • {items}</div>
                  <div className="text-sm font-normal">Rs{totalPrice}</div>
                </div>
                <div className="flex justify-between">
