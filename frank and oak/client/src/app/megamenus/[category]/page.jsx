...
import { fetchMegaProducts } from '@/app/redux/slices/megaMenuproductslice';
import Header from '@/app/common/Header';
import { Card } from '@/app/common/Card';


// This is the Product page to show the products
...
export default function Category() {
  ...
  const productCategories = useSelector((state) => state.megaMenu.value);
  ...
  useEffect(() => {
    ...
    if (productCategories.data) {
      const currentProduct = productCategories.data.filter(
        (cat) => cat.name === category
      );
      if(currentProduct.length>0){
      const id = currentProduct[0]._id;
      dispatch(fetchMegaProducts(id));
      console.log("productCategories===>",currentProduct[0].id);
    }
    else{
      console.error("No product category found for:", category);
    }
...
//       const id = currentProduct[0]._id;
//       dispatch(fetchMegaProducts(id));
//       console.log("productCategories===>", currentProduct[0]._id);
//     }
//   }, [megas, productCategories]);

//   return <div className="py-[200px]">page category page</div>;
// };
